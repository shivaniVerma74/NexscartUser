...
*/
                                ...
                                : (bool selected) {
                                    if (selected) if (mounted)
                                      setState(() {
                                        ...
                                        for (int i = 0;
                                            i <
                                                widget.model!.attributeList!.length;
                                            i++) {
  ...
  getProductDetails() async {
    var headers = {
      'Cookie': 'ci_session=88c9d21e4828a564d63158ad88356139b6f6cf52; ekart_security_cookie=1725e4354023ea3bd06ae4a50041caf3'
    };
    var request = http.MultipartRequest('POST', Uri.parse('https://nexuskart.co.in/app/v1/api/get_products'));
    request.fields.addAll({
      'p_limit': '${perPage.toString()}',
      'p_offset': '${notificationoffset.toString()}',
      'user_id': '${CUR_USERID}'
    });
    ...
    if (response.statusCode == 200) {
      ...
      final jsonResponse = ProductDetailsModel.fromJson(json.decode(result));
      setState(() {
        productDetailsModel =  jsonResponse;
      });
    }
    else {
        ...
        children: [
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text("${productDetailsModel?.data?[0].procurementType}")
              ],
            ),
          ),
          SizedBox(height: 3),
          Padding(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text("Procurement SLA (DAY):-"),
                Text("${productDetailsModel?.data?[0].procurementSlaDay}")
              ],
            ),
          ),
          SizedBox(height: 3,),
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text("${productDetailsModel?.data?[0].shippingProvider}")
              ],
            ),
          ),
          SizedBox(height: 3),
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text("Length (CM):-"),
                Text("${productDetailsModel?.data?[0].lengthCm}")
              ],
            ),
          ),
          SizedBox(height: 3,),
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text("Height (CM):-"),
                Text("${productDetailsModel?.data?[0].heightCm}")
              ],
            ),
          ),
          SizedBox(height: 3),
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text("Weight (KG):-"),
                Text("${productDetailsModel?.data?[0].weightKg}")
              ],
            ),
          ),
          SizedBox(height: 3,),
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text("Breadth (CM):-"),
                Text("${productDetailsModel?.data?[0].breadthCm}")
              ],
            ),
          ),
          SizedBox(height: 3,),
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text("HSN:-"),
                Text("${productDetailsModel?.data?[0].hsn}")
              ],
            ),
          ),
          SizedBox(height: 3,),
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text("Packer Details:-"),
                Text("${productDetailsModel?.data?[0].packerDetails}")
              ],
            ),
          ),
          SizedBox(height: 3),
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text("Tax Code:-"),
                Text("${productDetailsModel?.data?[0].taxCode}")
              ],
            ),
          ),
          SizedBox(height: 3),
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text("ISBN13:-"),
                Text("${productDetailsModel?.data?[0].isbn13}")
              ],
            ),
          ),
          SizedBox(height: 3),
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text("Language:-"),
                Text("${productDetailsModel?.data?[0].language}")
              ],
            ),
          ),
          SizedBox(height: 3),
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text("Edition:-"),
                Text("${productDetailsModel?.data?[0].edition}")
              ],
            ),
          ),
          SizedBox(height: 3),
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text("${productDetailsModel?.data?[0].publicationYear}")
              ],
            ),
          ),
          SizedBox(height: 3,),
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text("Publisher:-"),
                Text("${productDetailsModel?.data?[0].publisher}")
              ],
            ),
          ),
          SizedBox(height: 3),
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text("Pages:-"),
                Text("${productDetailsModel?.data?[0].pages}")
              ],
            ),
          ),
      ],
